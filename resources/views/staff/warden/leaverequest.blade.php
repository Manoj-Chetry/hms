...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{URL::asset('css/staff/warden/leave.css')}}">
                                ...
                                @else
                                    @foreach ($leave as $i=>$l)
                                        <tr>
                                            ...
                                            <td>{{$l->status}}</td>
                                            <td>
                                                <form action="{{route('staff.warden.leave.approve', $l->id)}}" method="post">
                                                    @csrf
                                                    <button type="submit" class="action-btn">Approve</button>
                                                </form>
                                                <form action="{{route('staff.warden.leave.reject', $l->id)}}" method="post">
                                                    @csrf
